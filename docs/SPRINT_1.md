...
- [ ] Commit this file to `/docs/SPRINT_1.md` on the main branch.
- [ ] Grant instructor/TA collaborator access to the repo.
- [ ] Verify the Mermaid diagram renders correctly on GitHub (preview before submitting).
- [ ] Submit repo URL to the LMS.
